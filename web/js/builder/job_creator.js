...
var creatorApp = function () {
    ...
    this.param = {
        ...
        closeFieldsBtn: '.btn-close-fields-dialog',
    ...
    this.bindLoadEvents = function () {
        ...
        $(document)
			...
			//Click close fields dialog template button
			.on('click', g.param.closeFieldsBtn, function () {
				alert('Close');
            ...
            .on('submit', g.param.formSecondStep, function () {
				...
				template_layout_json_obj[0].form_values = $("#alias_framework_create_form").serializeArray();
